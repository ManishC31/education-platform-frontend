      ...
      <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200 mt-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center p-3 bg-gray-50 rounded-lg">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-900">Course "JavaScript Advanced" published</p>
          ...
          <div className="flex items-center p-3 bg-gray-50 rounded-lg">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-900">Received payment for "Python Basics"</p>
